...
<html lang="en">
<head>
    <title>Code coverage report for token.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> token.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as rp from 'request-promise-native'
&nbsp;
...
export function calculateTK(text, tkk) {
    ...
    const tkkFirst = Number(tkkList[0]) || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    const tkkSecond = Number(tkkList[1]) || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
...
&nbsp;
    const reqOpts = {
        method: 'get',
        url: 'https://translate.google.' + (opts.tld || <span class="branch-1 cbranch-no" title="branch not covered" >'com')</span>,
        ...opts.config
    }
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.proxy) {
<span class="cstat-no" title="statement not covered" >        reqOpts.proxy = `http://${opts.proxy.host}:${opts.proxy.port}`</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        throw new Error('Cannot get TKK.')</span>
    }
&nbsp;
    const tkk = matches[1];
    return tkk;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Sep 09 2019 17:34:56 GMT+0800 (China Standard Time)
</div>
</div>
